...
@Document("champions")
public record recodeChampions(@Id String _id, String name, String championId, Integer cost, List<String> traits) {

    @PersistenceConstructor
    public recodeChampions {}

    public recodeChampions(String name, String championId, Integer cost, List<String> traits) {
